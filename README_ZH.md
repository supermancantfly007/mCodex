...
**在手机上通过可信局域网使用 Codex Desktop**

Codex Desktop 留在 Windows 电脑上，你可以从手机查看任务、补充指令、处理审批并发起新工作。
...
1. 手机和电脑连接同一个可信 Wi-Fi 或局域网。
2. 使用上面任意一种方式启动 mCodex。
3. 扫描电脑页面上的二维码，或打开页面显示的局域网地址并输入配对码。
...
| **官方 ChatGPT 手机 App** | 它是独立的 ChatGPT 使用体验，并不是本机 Codex Desktop 项目、任务、审批和文件修改的移动视图。 | mCodex 通过可信局域网保留当前 Desktop 任务上下文。 |
...
| 手机打不开页面 | 确认两台设备位于同一局域网，并允许专用网络访问端口 `3210` |
